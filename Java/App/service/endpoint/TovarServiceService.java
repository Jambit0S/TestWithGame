 ...
 * 
 */
@WebServiceClient(name = "TovarServiceService", targetNamespace = "http://endpoint.service/", wsdlLocation = "http://localhost:8081/ws02/TovarService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/ws02/TovarService?wsdl");
